...
class Sick {
  ...
  static Future<Sick> connectToAPI(String startDate, String lastDate, String letter) async {
    String apiUrl = "URL API";
    var apiResutl = await http.post(apiUrl, body: {"startDate" : startDate, "lastDate" : lastDate, "letter" : letter});
